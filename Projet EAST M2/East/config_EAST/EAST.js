function make_print() {
    ...
    liste_div_print = document.getElementsByClassName('print') ;			
    
    var ldp=liste_div_print.length ;
	...
	liste_div_print[i].setAttribute("style","left: 0cm ; top: 0cm ; width: 23.5cm ; height: 14.3cm");
	...
	liste_div_print[i].setAttribute("style","left: 0.8cm ; top: 1cm ; width: 27cm ; height: 18cm");
	...
	liste_div_print[i].setAttribute("style","left: 0cm ; top: 0cm ; width: 25.5cm ; height: 15cm");
	...
	liste_div_print[i].setAttribute("style","left: 0cm ; top: 1cm ; width: 29cm ; height: 18cm");
